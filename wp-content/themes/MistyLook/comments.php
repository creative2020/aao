...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			<div class="cmtinfo"><em><?php edit_comment_link('edit this','',''); ?> on <?php comment_date('d M Y') ?> at <?php comment_time() ?></em><cite><?php comment_author_link() ?></cite></div>
			...
			<?php echo get_avatar($comment, (empty($options['avatar-size']) ? 25 : $options['avatar-size']))?>	
			</div>
			<?php comment_text() ?>			
		</li>
